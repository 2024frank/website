  ...
  const allProjects = [
    {
      ...
      status: 'In Progress',
      contributors: 8,
      description: 'An open-source e-learning platform tailored for African educational contexts with offline capabilities and localized content.',
    ...
    },
    {
      ...
      status: 'Completed',
      contributors: 12,
      description: 'A telemedicine application that connects patients in rural areas with healthcare professionals, supporting low-bandwidth connections.',
    ...
    },
    {
      ...
      status: 'In Progress',
      contributors: 6,
      description: 'Blockchain-based supply chain solution for African farmers to track produce from farm to market, ensuring fair pricing and reducing waste.',
    ...
    },
    {
      ...
      status: 'In Progress',
      contributors: 10,
      description: 'A cross-border payment solution for African businesses and freelancers, with lower fees and faster processing times than traditional methods.',
    ...
    },
    {
      ...
      status: 'Completed',
      contributors: 5,
      description: 'IoT system for monitoring and optimizing solar panel installations in off-grid African communities.',
    ...
    },
    {
      ...
      status: 'In Progress',
      contributors: 7,
      description: 'Mapping informal transportation networks in African cities to improve accessibility and planning.',
